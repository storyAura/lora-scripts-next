...
CHANGELOG_BANNER_HTML = (
    ...
    f'alt="Next Story Trainer" loading="lazy" width="960" height="420"></div>'
)
...
def patch_home_logo() -> None:
    ...
    html = re.sub(
        r'<img src="/assets/icon\.65fd68ba\.webp[^"]*" width="200" height="200" alt="Next Story Trainer"[^>]*>',
        f'<img src="{HOME_LOGO}" class="sd-home-logo" width="300" height="300" alt="Next Story Trainer" loading="lazy">',
        html,
        count=1,
    )
    html = html.replace(
