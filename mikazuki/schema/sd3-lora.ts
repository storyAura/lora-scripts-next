Schema.intersect([
    Schema.object({
        ...
        lora_type: Schema.union(["lora", "rslora", "lora_plus", "dora", "delora", "waveft", "deft", "moslora", "lokr", "glokr", "cdka", "tlora", "lora_fa", "vera", "loha", "bokr", "bora", "gsokr", "glora_boft"]).default("lora").description("适配器类型。常规训练建议 LoRA；各算法的区别、适用场景与专属参数详见「帮助 → 训练算法说明」页"),
    ...
    Schema.intersect([
        ...
        Schema.union([
            ...
            Schema.object({
                ...
                dora_wd: Schema.boolean().default(false).description("启用 DoRA 权重解耦（单向幅度解耦）。与 bypass 模式互斥"),
