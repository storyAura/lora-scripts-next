Schema.intersect([
    Schema.object({
        ...
        lora_type: Schema.union(["lora", "rslora", "lora_plus", "dora", "delora", "waveft", "deft", "moslora", "lokr", "cdka", "tlora", "lora_fa", "vera", "loha", "bokr", "bora", "gsokr", "glora_boft"]).default("lora").description("适配器类型。常规训练建议 LoRA；各算法的区别、适用场景与专属参数详见「帮助 → 训练算法说明」页"),
